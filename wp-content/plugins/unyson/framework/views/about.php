...
?>
    ...
    <div class="wrap about-wrap full-width-layout" style="margin:0 auto;">
        ...
        <div class="inline-svg full-width">
            <iframe width="1200" height="600" src="https://www.youtube.com/embed/KUv-NqDR-8s?rel=0&amp;showinfo=0"
        ...
        <div class="feature-section">
            ...
            <p style="font-size: 14px; text-align:center;">
                Brizy is developed by the team behind the <a href="https://wordpress.org/plugins/unyson/"
                                                             target="_blank">Unyson open source framework</a> for
                WordPress. The content created with the back end visual page builder from Unyson can’t be edited with
                Brizy. You can however use Brizy to create new pages. Consider joining our <a
                        href="https://www.facebook.com/brizy.io/" target="_blank">Facebook community</a> where our
                members help us shape the development of Brizy.
            </p>
        </div>
