<?php
/*
Template Name: Prescription Report Preview
*/
...
global $wpdb;
$prescriptions = $wpdb->get_results("SELECT * FROM prescriptions where created_at >= '$start' and created_at <='$end'");
...
<div class="bt-div">
    ...
    <button class="button blue" onclick="window.location='<?= site_url("prescription-report") ?>'">Back</button>
    <hr>
    Page size: A4
</div>
<div class="wraper">
    <table width="100%">
        <tr>
            ...
            <td width="81%" align="left" valign="top">
                <h1>Prescription Submission Report</h1>
                <hr>
                <h3>From
    ...
    <table width="100%" class="table">
        ...
        <tr>
            ...
            <th><?php esc_html_e('Address'); ?></th>
            <th><?php esc_html_e('Mobile'); ?></th>
            <th><?php esc_html_e('Mobile Alternative'); ?></th>
        ...
        if (count($prescriptions) > 0) {
            foreach ($prescriptions as $prescription) {
                ...
                <tr>
                    ...
                    <td><?php echo esc_attr($prescription->name); ?></td>
                    <td><?php echo esc_attr($prescription->email); ?></td>
                    <td><?php echo esc_attr($prescription->address); ?></td>
                    <td><?php echo esc_attr($prescription->mobile); ?></td>
                    <td><?php echo esc_attr($prescription->mobile_alternative); ?></td>
                    <td>
                        <a href="<?= site_url('wp-content/uploads/prescription/' . $prescription->prescription_file); ?>">Download</a>
                    </td>
                    <td><?php echo esc_attr(date('d-m-Y', strtotime($prescription->created_at))); ?></td>
