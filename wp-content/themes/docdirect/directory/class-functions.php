                    ...
                    <?php if( $url_identity ==  $user_identity ) { ?>
                        ...
                        <?php if( isset( $article_switch ) && $article_switch === 'enable' ){?>
                      	...
                      	<?php if(!empty($is_chat) && $is_chat === 'yes') { ?>
							<li class="<?php echo($reference === 'private-chat' ? 'active':''); ?> tg-privatemessages"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'private-chat', $user_identity); ?>"><?php esc_html_e('Inbox', 'docdirect'); ?></a>
            ...
            <?php } else{
                ...
                <ul>
                    ...
                    <?php if( isset( $article_switch ) && $article_switch === 'enable' ){?>
                  	...
                  	<?php if(!empty($is_chat) && $is_chat === 'yes') { ?>
						<li class="<?php echo ( $reference === 'private-chat' ? 'active':'');?> tg-privatemessages"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'private-chat', $user_identity); ?>"><i class="fa fa-comment-o"></i><?php esc_html_e('Inbox','docdirect');?></a>
							<span class="tg-totalmessages"><?php echo intval($unread); ?></span>
						</li>
					<?php } ?>
