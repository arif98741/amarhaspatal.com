...
if (!class_exists('DocDirect_Scripts')) {
    class DocDirect_Scripts
    {
        ...
        public function docdirect_profile_menu($menu_type = "dashboard")
        {
            ...
            $unread = 0;
            if (class_exists('ChatSystem') && (!empty($is_chat) && $is_chat === 'yes')) {
                $count = ChatSystem::getUsersThreadListData($user_identity, '', 'count_all_unread_msgs');
            ...
            if (is_user_logged_in()) {
                        ...
                        <ul class="docdirect-menu">
                            <?php if ($url_identity == $user_identity) { ?>
                                <li class="<?php echo($reference === 'dashboard' ? 'active' : ''); ?>"><a
                                            href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'dashboard', $user_identity); ?>"><?php esc_html_e('My Profile', 'docdirect'); ?></a>
                                </li>
                                <?php if (class_exists('bbPress')) { ?>
                                    <li style="display: none">
                                        <a href="<?php echo esc_url(bbp_get_user_profile_url($user_identity)); ?>"><?php esc_html_e('Go to forum profile', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>
                                <li class="<?php echo($reference === 'settings' ? 'active' : ''); ?>"><a
                                ...
                                <?php if (apply_filters('docdirect_do_check_user_type', $user_identity) === true) { ?>
                                    <?php if (apply_filters('docdirect_is_setting_enabled', $user_identity, 'favorite') === true) { ?>
                                        <li class="<?php echo($reference === 'wishlist' ? 'active' : ''); ?>"><a
                                                    href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'wishlist', $user_identity); ?>"><?php esc_html_e('Favourites', 'docdirect'); ?></a>
                                        </li>
                                    <?php } ?>
                                <?php } else { ?>
                                    <li class="<?php echo($reference === 'wishlist' ? 'active' : ''); ?>"><a
                                ...
                                if (apply_filters('docdirect_do_check_user_type', $user_identity) === true
                                    ...
                                    <li class="<?php echo($reference === 'schedules' ? 'active' : ''); ?>"><a
                                                href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'schedules', $user_identity); ?>"><?php esc_html_e('My Schedules', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php } else { ?>
                                    <li class="<?php echo($reference === 'bookings' ? 'active' : ''); ?>"><a
                                                href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><?php esc_html_e('My appointmens', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>
                                ...
                                if (apply_filters('docdirect_do_check_user_type', $user_identity) === true
                                    ...
                                    ?>
                                    <li class="<?php echo($reference === 'booking-schedules' ? 'active' : ''); ?>"><a
                                                href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'booking-schedules', $user_identity); ?>"></i><?php esc_html_e('Booking Schedules', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>
                                <?php
                                if (apply_filters('docdirect_do_check_user_type', $user_identity) === true
                                    ...
                                    ?>
                                    <li class="<?php echo($reference === 'booking-settings' ? 'active' : ''); ?>"><a
                                                href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'booking-settings', $user_identity); ?>"><?php esc_html_e('Booking Settings', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>

                                <li class="<?php echo($reference === 'security' ? 'active' : ''); ?>"><a
                                            href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'security', $user_identity); ?>"><?php esc_html_e('Security Settings', 'docdirect'); ?></a>
                                </li>
                                ...
                                <?php if (is_user_logged_in()) { ?>
                                    <li>
                                        <a href="<?php echo esc_url(wp_logout_url(home_url('/'))); ?>"><?php esc_html_e('Logout', 'docdirect'); ?></a>
                                    </li>
                                <?php } ?>
                            ...
                            <?php } else { ?>
                                <li class=""><a
                                            href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'dashboard', $user_identity); ?>"><?php esc_html_e('Go to your profile', 'docdirect'); ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
                <?php } else {
                    ...
                    <ul>
                        ...
                        <?php } ?>
                        <li class="<?php echo($reference === 'settings' ? 'active' : ''); ?>"><a
                                    href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'settings', $user_identity); ?>"><i
                                        class="fa fa-gears"></i><?php esc_html_e('Profile Settings', 'docdirect'); ?>
                            </a></li>
                        ...
                        <?php if (apply_filters('docdirect_do_check_user_type', $user_identity) === true) { ?>
                            <?php if (apply_filters('docdirect_is_setting_enabled', $user_identity, 'appointments') === true) { ?>
                                <li class="<?php echo($reference === 'bookings' ? 'active' : ''); ?>"><a
                                            href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><i
                                                class="fa fa-book"></i><?php esc_html_e('Booking Listings', 'docdirect'); ?>
                                    </a></li>
                            <?php } ?>
                        <?php } else { ?>
                            <li class="<?php echo($reference === 'bookings' ? 'active' : ''); ?>"><a
                                        href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><i
                                            class="fa fa-book"></i><?php esc_html_e('My appointmens', 'docdirect'); ?>
                                </a></li>
                        <?php } ?>
                        ...
                        if (apply_filters('docdirect_do_check_user_type', $user_identity) === true
                            ...
                            ?>
                            <li class="<?php echo($reference === 'booking-schedules' ? 'active' : ''); ?>"><a
                                        href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'booking-schedules', $user_identity); ?>"><i
                                            class="fa fa-calendar-check-o"></i><?php esc_html_e('Booking Schedules', 'docdirect'); ?>
                                </a></li>
                        <?php } ?>
                        <?php
                        if (apply_filters('docdirect_do_check_user_type', $user_identity) === true
                            ...
                            ?>
                            <li class="<?php echo($reference === 'booking-settings' ? 'active' : ''); ?>"><a
                                        href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'booking-settings', $user_identity); ?>"><i
                                            class="fa fa-cog"></i><?php esc_html_e('Booking Settings', 'docdirect'); ?>
                                </a></li>
                        <?php } ?>

                        <li class="<?php echo($reference === 'security' ? 'active' : ''); ?>"><a
                                    href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'security', $user_identity); ?>"><i
                                        class="fa fa-lock"></i><?php esc_html_e('Security Settings', 'docdirect'); ?>
                            </a></li>
                        <?php if (apply_filters('docdirect_do_check_user_type', $user_identity) === true) { ?>
                            <li class="<?php echo($reference === 'privacy-settings' ? 'active' : ''); ?>"><a
                                        href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'privacy-settings', $user_identity); ?>"><i
                                            class="fa fa-eye"></i><?php esc_html_e('Privacy Settings', 'docdirect'); ?>
                                </a></li>
                        <?php } ?>
        ...
        function docdirect_get_avatar()
        {
            ...
            $featured_string = docdirect_get_user_featured_date($user_identity);
            ...
            <div class="tg-widget tg-widget-doctor">
                <figure class="tg-docprofile-img">
                    <figcaption>
                        <h4><a target="_blank" title="<?php esc_html_e('View Profile', 'docdirect'); ?>"
                               href="<?php echo get_author_posts_url($user_identity); ?>"><?php echo esc_attr($username); ?></a>
                        </h4>
                    ...
                    <a><img src="<?php echo esc_url($avatar); ?>"
                            alt="<?php esc_html_e('Avatar', 'docdirect'); ?>"/></a>
                </figure>
            </div>
            <?php
        }
                                ...
                                <ul class="tg-doccontactinfo">
                                    <?php if (get_user_meta('address', $user_identity, true)) : ?>
                                        <li><i class="fa fa-map-marker"></i>
                                            <address><?php echo get_user_meta('address', $user_identity, true); ?></address>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('phone', $user_identity)) : ?>
                                        <li><i class="fa fa-phone"></i><a
                                                    href="tel:<?php echo get_user_meta('phone', $user_identity, true); ?>"><?php echo get_user_meta('phone', $user_identity, true); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('email', $user_identity)) : ?>
                                        <li><i class="fa fa-envelope-o"></i><a
                                                    href="mailto:<?php echo get_user_meta('email', $user_identity, true); ?>?Subject=<?php esc_html_e('Hello', 'docdirect'); ?>"
                                                    target="_top"><?php echo get_user_meta('email', $user_identity, true); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('fax', $user_identity)) : ?>
                                        <li>
                                            <i class="fa fa-fax"></i><span><?php echo get_user_meta('fax', $user_identity, true); ?></span>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                                <div class="profile-social-icons">
                                    <?php if (get_user_meta('facebook', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('facebook', $user_identity, true); ?>"><i
                                                        class="fa fa-facebook"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('twitter', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('twitter', $user_identity, true); ?>"><i
                                                        class="fa fa-twitter"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('linkedin', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('linkedin', $user_identity, true); ?>"><i
                                                        class="fa fa-linkedin"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('pinterest', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('pinterest', $user_identity, true); ?>"><i
                                                        class="fa fa-pinterest"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('google_plus', $user_identity)) : ?>
                                        <span><a href="<?php echo get_user_meta('google_plus', $user_identity, true); ?>"><i
                                                        class="fa fa-google-plus"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('tumblr', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('tumblr', $user_identity, true); ?>"><i
                                                        class="fa fa-tumblr"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('instagram', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('instagram', $user_identity, true); ?>"><i
                                                        class="fa fa-instagram"></i></a></span>
                                    <?php endif; ?>
                                    <?php if (get_user_meta('skype', $user_identity, true)) : ?>
                                        <span><a href="<?php echo get_user_meta('skype', $user_identity, true); ?>"><i
