...
<div class="main-content container-fluid mslc">
    <div style="border: 1px solid #eee; padding: 8px;">
        <div style="background-image: url(<?php echo site_url(); ?>/wp-content/uploads/directory-list-banner/hospital.png);
                        ...
                        <div class="container-fluid" style="padding-top: 30px; padding-bottom: 30px;">
                            ...
                            <div class="row">
                                <div class="col-md-4 user-profile-dir-list">
                                    ...
                                    <?php if (empty($avatar)): ?>
                                        <a href="<?php echo site_url(); ?>/hospital/<?php echo $directories_array['user_nicename']; ?>">
                                ...
                                <div class="col-md-8 iiiii">
                                    ...
                                    <div class="a2a_kit a2a_kit_size_32 a2a_default_style"
                                         data-a2a-url="<?php echo site_url(); ?>/hospital/<?php echo $directories_array['user_nicename']; ?>"
                                         data-a2a-title="<?= ucfirst($directories_array['name']); ?>"
                                         style="line-height: 32px;">
                                        <a class="a2a_dd"
                                           href="https://www.addtoany.com/share#url=<?php echo site_url(); ?>/hospital/<?php echo $directories_array['user_nicename']; ?>">
