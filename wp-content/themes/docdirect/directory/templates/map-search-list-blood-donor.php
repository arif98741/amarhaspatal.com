...
<div class="main-content container-fluid mslc">
    ...
    padding: 11px;"
                                ...
                                <?php else: ?>
                                    <a href="#">
                                        <img src="<?= $avatar ?>" style="width: 318px;
    height: 300px;
    border: 1px solid #dad7d7;
    padding: 5px;
    margin-top: 16px;
    padding: 11px;"
                            ...
                            <div class="col-md-8 iiiii">
                                ...
                                <p><i class="fa fa-tint fa-lg" style="margin-right: 20px;"></i>Blood
                                    Group: <?= (!empty($directories_array['blood_group'])) ? $directories_array['blood_group'] : 'N/A'; ?>
                                </p>
                                <p><i class="fa fa-calendar fa-lg" style="margin-right: 20px;"></i>Last Donation
                                    Date: <?= (!empty($directories_array['last_donation_date'])) ? $directories_array['last_donation_date'] : 'N/A'; ?>
                                </p>
