            ...
            <div class="row">
                <div class="tg-otherphotos">
                    <div class="tg-heading-border tg-small">
                        ...
                        <p>These photo will be used as your gallery photo for viewers.</p>

                    </div>
                    <div class="gallery-button">
                        <div id="plupload-container-gallery">
                            <button type="button" id="attach-gallery"
                                    class="tg-btn tg-btn-lg"><?php esc_html_e('Choose Photos', 'docdirect'); ?></button>
                        </div>
                    </div>
                                ...
                                if (isset($user_gallery) && !empty($user_gallery)) {
                                    foreach ($user_gallery as $key => $value) {
                                        ...
                                        <li class="gallery-item gallery-thumb-item data-gallery-wrap">
                                            <figure>
                                                <a href="javascript:;"><img width="100" height="100"
                                                                            src="<?php echo esc_attr($value['url']); ?>"
                                                                            alt="<?php esc_attr_e('Gallery', 'docdirect'); ?>"></a>
                                                <div class="tg-img-hover"><a class="del-gallery" href="javascript:;"
                                                                             data-attachment="<?php echo esc_attr($value['id']); ?>"><i
                                                                class="fa fa-plus"></i><i
                                                                class='fa fa-refresh fa-spin'></i></a></div>

                                            </figure>
                                            <input type="hidden" value="<?php echo esc_attr($value['id']); ?>"
                                                   name="user_gallery[<?php echo esc_attr($value['id']); ?>][attachment_id]">
                                            <input type="hidden" value="<?php echo esc_attr($value['url']); ?>"
                                                   name="user_gallery[<?php echo esc_attr($value['id']); ?>][url]">
                                        </li>
                                    <?php }
                                } ?>
