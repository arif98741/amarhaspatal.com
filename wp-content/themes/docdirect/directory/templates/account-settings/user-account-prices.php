...
if (apply_filters('docdirect_do_check_user_type', $user_identity) === true && $db_directory_type != '123') {
                                ...
                                <tr>
                                    <td data-title="Title"><?php echo esc_attr($value['title']); ?>
                                        <div class="tg-table-hover prices-action">
                                            <a href="javascript:;" class="delete-me"><i
                                                        class="tg-delete fa fa-close"></i></a>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input class="form-control"
                                                           ...
                                                           name="prices[<?php echo intval($counter); ?>][title]"
                                                           type="text"
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <input class="form-control"
                                                           ...
                                                           name="prices[<?php echo intval($counter); ?>][price]"
                                                           type="text"
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <textarea class="form-control"
                                                              name="prices[<?php echo intval($counter); ?>][description]"
                                                              placeholder="<?php esc_attr_e('Description', 'docdirect'); ?>"><?php echo esc_attr($value['description']); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
