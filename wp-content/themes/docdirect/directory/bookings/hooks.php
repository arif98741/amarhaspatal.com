...
if (!function_exists('docdirect_update_service_category')) {
    function docdirect_update_service_category()
    {
        ...
        $services = get_user_meta($user_identity, 'services_cats', true);
...
if (!function_exists('docdirect_add_time_slots')) {
    function docdirect_add_time_slots()
    {
        ...
        $slot_title_chamber = esc_attr($_POST['slot_title_chamber']);
        ...
        do {
            ...
            $default_slots[$day . '-details'][$start_time . '-' . $newStartTime]['slot_title_chamber'] = $slot_title_chamber;
