          ...
          <tr class="<?php echo esc_attr( $trClass );?> booking-<?php echo intval( $post->ID );?>">
            ...
            <td>
               ...
               <?php }else if( isset( $bk_status ) && $bk_status == 'pending' ){?>
                	<a class="tg-btncheck appointment-actioned appointment-pending fa fa-spinner" href="javascript:;"><?php esc_html_e('Pending','docdirect');?></a> 
                <?php }?>
            ...
            <td colspan="6">
                <div class="appointment-data-wrap">
                    <ul class="tg-leftcol">
                      ...
                      <li>
                            <strong><?php esc_html_e('Location of visit','docdirect');?>:</strong>
