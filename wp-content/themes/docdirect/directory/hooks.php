        ...
        <div class="feature-rating user-star-rating">
            ...
            if (isset($show_rating) && $show_rating === 'show') {
                if (!empty($review_data['average_rating'])) {
                    ?>
                    <em><?php echo number_format((float)$review_data['average_rating'], 1, '.', ''); ?>
                        <sub>/5</sub></em>
                <?php }
            } ?>
        </div>
...
if (!function_exists('docdirect_get_rating_stars_v2')) {
    function docdirect_get_rating_stars_v2($review_data = '', $return_type = 'echo', $show_rating = 'show')
    {
        ...
        ?>
        <li><span class="doc-stars"><span
                        style="width:<?php echo esc_attr($review_data['percentage']); ?>%"></span></span></li>
        <?php
        if ($return_type === 'return') {
            return ob_get_clean();
        } else {
                ...
                <div class="doc-widgetcontent">
                    <fieldset>
                                ...
                                <script type="text/template" id="tmpl-load-chilcategories">
                                    ...
                                    <div class="doc-widget doc-widgetfilterspecialist">
                                        ...
                                        <div class="doc-widgetcontent">
                                            ...
                                            #>
                                            <div class="doc-checkbox">
                                                <input type="checkbox" name="sub_category[]" {{_checked}}
                                                       value="{{index}}" id="sub_category-{{index}}">
                                ...
                                <div class="form-group">
                                    <div class="doc-select">
                                        <select name="languages[]" class="chosen-select"
                                                data-placeholder="<?php esc_attr_e('Select languages', 'docdirect'); ?>"
                                                multiple>
                                            <?php
                        ...
                        <?php if (isset($dir_phote) && $dir_phote === 'enable') { ?>
                            <div class="doc-checkbox">
                                <input type="checkbox"
                                       name="photos" <?php echo isset($photos) && $photos === 'true' ? 'checked' : ''; ?>
                                       id="photos" value="true">
                        ...
                        <?php if (isset($dir_appointments) && $dir_appointments === 'enable') { ?>
                            <div class="doc-checkbox">
                                <input type="checkbox"
                                       name="appointments" <?php echo isset($appointments) && $appointments === 'true' ? 'checked' : ''; ?>
                                       id="appointment" value="true">
                                <label for="appointment"><?php esc_html_e('Online Appointment', 'docdirect'); ?></label>
                            </div>
                        <?php } ?>
                        <div class="doc-btnarea">
                            <button class="doc-btn"
                                    type="submit"><?php esc_html_e('Apply Filter', 'docdirect'); ?></button>
                            <button class="doc-btn tg-btn-reset"
                                    type="reset"><?php esc_html_e('Reset Filter', 'docdirect'); ?></button>
                            <input type="hidden" name="view"
                                   value="<?php echo !empty($_GET['view']) ? $_GET['view'] : ''; ?>"/>
                        </div>
                    </fieldset>
                </div>
            </div>
...
if (!function_exists('docdirect_display_provider_category')) {
    ...
    function docdirect_display_provider_category($user_id)
    {
        ...
        <a class="doc-themetag tg-categorytag sp-av-link" <?php echo esc_attr($bg_color); ?>
