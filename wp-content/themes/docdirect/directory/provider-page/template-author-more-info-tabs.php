        ...
        <div class="tg-companyfeaturebox tg-reviews">
            <ul class="tg-reviewstabs" role="tablist">
                <?php if (isset($reviews_switch) && $reviews_switch === 'enable') { ?>
                    <li role="presentation" class="<?php echo esc_attr($tabClass); ?>"><a href="#reviews"
                                                                                          aria-controls="reviews"
                                                                                          role="tab"
                                                                                          data-toggle="tab"><?php esc_html_e('Reviews', 'docdirect'); ?></a>
                    </li>
                    <?php $tabClass = '';
                } ?>
                <?php
                    ...
                    if (function_exists('fw_get_db_settings_option') && fw_ext('questionsanswers')) {
                        if (apply_filters('docdirect_get_theme_settings', 'qa_restriction') === 'paid') {
                            if (apply_filters('docdirect_is_setting_enabled', $author_profile->ID, 'dd_qa') === true) {
                                ?>
                                <li class="<?php echo esc_attr($tabClass); ?>" role="presentation"><a href="#consult"
                                                                                                      aria-controls="consult"
                                                                                                      role="tab"
                                                                                                      data-toggle="tab"><?php esc_html_e('Consult Q&A', 'docdirect'); ?></a>
                                </li>
                            <?php } ?>
                        <?php } else { ?>
                            <li class="<?php echo esc_attr($tabClass); ?>" role="presentation"><a href="#consult"
                ...
                if (isset($questions) && $questions === 'enable') {
                    if (function_exists('fw_get_db_settings_option') && fw_ext('questionsanswers')) {
                        if (apply_filters('docdirect_get_theme_settings', 'qa_restriction') === 'paid') {
                            if (apply_filters('docdirect_is_setting_enabled', $author_profile->ID, 'dd_qa') === true) {
                                ?>
                                <div role="tabpanel" class="tg-tabpane tab-pane <?php echo esc_attr($tabClass); ?>"
                                     id="consult">
