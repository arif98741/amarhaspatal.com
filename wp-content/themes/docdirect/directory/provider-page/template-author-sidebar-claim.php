            ...
            <div class="tg-widgetcontent doc-claim">
                ...
                <form class="tg-haslayout claim_form tg-claimform">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <textarea name="report" placeholder="<?php esc_attr_e('Report Detail', 'docdirect'); ?>"
                                      class="form-control"></textarea>
                        </div>
                        <button class="tg-btn report_now"
                                type="submit"><?php esc_html_e('report now', 'docdirect'); ?></button>
