                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h1>
                                ...
                                <?php if (isset($_GET['directory_type']) && esc_html($_GET['directory_type']) == 121) : ?>
                                    Diagonostics

                                <?php elseif (isset($_GET['directory_type']) && esc_html($_GET['directory_type']) == 122) : ?>
                                    Blood Donor

                                <?php elseif (isset($_GET['directory_type']) && esc_html($_GET['directory_type']) == 123) : ?>
                                    Ambulance

                                <?php elseif (isset($_GET['directory_type']) && esc_html($_GET['directory_type']) == 126) : ?>
                                    Hospitals
                                <?php elseif (isset($_GET['directory_type']) && esc_html($_GET['directory_type']) == 127) : ?>
                                    Doctor
                                <?php else : ?>
