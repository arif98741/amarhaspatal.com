    ...
    class TG_LATEST_LISTINGS extends WP_Widget
    {
        ...
        public function form($instance)
        {
            ...
            <p>
                ...
                <input type="text" id="title" name="<?php echo esc_attr($this->get_field_name('title')); ?>"
                    ...
                    if (isset($cust_query) && !empty($cust_query)) {
                        foreach ($cust_query as $key => $dir) {
                            ...
                            <option <?php echo esc_attr($selected); ?>
                                    value="<?php echo intval($dir->ID); ?>"><?php echo esc_attr($title); ?></option>
                        <?php }
                    } ?>
                </select>
            ...
            <p>
                ...
                <input type="number" id="number" name="<?php echo esc_attr($this->get_field_name('number')); ?>"
                ...
                <ul>
                    ...
                    if (!empty($user_query->results)) {
                        foreach ($user_query->results as $user) {
                            ...
                            ?>
                            <li>
                                <figure><img src="<?php echo esc_url($avatar); ?>"
                                             alt="<?php esc_html_e('User', 'docdirect'); ?>"></figure>
                                <div class="doc-doctorname">
                                    ...
                                    <?php if (!empty($user->tagline)) { ?>
                                        <span><?php echo esc_attr($user->tagline); ?></span><?php } ?>
                                </div>
                            </li>
                        <?php }
                        ?>
                        <?php if (!empty($search_page)) { ?>
                            <li class="doc-btnviewall"><a
                                        href="<?php echo esc_url($search_page); ?>?order=DESC<?php echo esc_attr($slug); ?>"><?php esc_html_e('View All', 'docdirect'); ?>
