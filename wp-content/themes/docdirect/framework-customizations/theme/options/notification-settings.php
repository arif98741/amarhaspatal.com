        ...
        'options' => array(
			...
			'provider_settings' => array(
				...
				'options' => array(
					...
					'new_messages_main' => array(
						'title' => esc_html__('New Message', 'docdirect'),
						'type' => 'tab',
						'options' => array(
							'new_messages' => array(
								'type' => 'multi-picker',
								...
								'picker' => array(
									'gadget' => array(
										'type'  => 'switch',
										'value' => 'disable',
										'label' => esc_html__('New messages', 'docdirect'),
										'desc'  => esc_html__('This template will be used for new messages.', 'docdirect'),
										'left-choice' => array(
											'value' => 'enable',
								...
								'choices' => array(
									'enable' => array(
										...
										'message_info' => array(
											...
											'desc'  => esc_html__('', 'docdirect'),
											'help'  => esc_html__('', 'docdirect'),
											'html'  => '%user_name% — To display user name.<br/>
														%from_user_name% — To display username who send the message.<br/>
										...
										'message_subject' => array(
											'type' => 'text',
											'value' => 'A new message has received!',
											'label' => esc_html__('Subject', 'docdirect'),
											'desc' => esc_html__('Please add subject for email', 'docdirect'),
										),
										'messages_content' => array(
											'type'  => 'wp-editor',
											'value' => 'Hi %user_name%!<br/>
