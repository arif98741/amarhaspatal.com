...
$user_featured_data		= docdirect_get_user_featured_date($user_identity);
            ...
            <div class="tg-formsection">
                ...
                <div class="form-group">  
                    <div class="tg-privacy"> 
                      ...
                      <?php if( !empty( $user_featured_data['is_featured'] ) && $user_featured_data['is_featured'] === 'yes' ){?>
                      	<p><?php esc_html_e('You can also remove a user from featured list just click on button just given below.','docdirect');?></p>
                      <?php }?>
						<?php if( !empty( $user_featured_data['featured_till'] ) && $user_featured_data['featured_till'] > $today ){?>
							<strong><?php echo esc_attr( date_i18n('l, F j, Y',$user_featured_data['featured_till'] ) );?> <?php esc_html_e('at','docdirect');?> <?php echo esc_attr( date_i18n('H:i A', $user_featured_data['featured_till'] ));?></strong>
						<?php } ?>
                    <div class="featured-field">
                    ...
                    <?php if( !empty( $user_featured_data['is_featured'] ) && $user_featured_data['is_featured'] === 'yes' ){?>
                       <?php if( !empty( $user_featured_data['featured_till'] ) && $user_featured_data['featured_till'] > $today  ){?>
                        <div class="featured-field featured_detail_wrap">
                            <span class="tg-privacy-name"><?php esc_html_e('Exclude days from featured','docdirect');?></span>
                            <div class="expiry-date-wrap">
								<div class="custom_or"><?php esc_html_e('Remove specific number of days from expiry date','docdirect');?></div>
