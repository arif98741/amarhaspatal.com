        ...
        if (isset($is_profile_visible) && $is_profile_visible === 'yes') { ?>
            ...
            <div style="border: 0px solid red;" class="main-content container-fluid mslc">
                ...
                <main id="main" class="site-main" role="main">
                    ...
                    >
                         ...
                         <?php if (empty($avatar)): ?>
                             ...
                             <img class="img-responsive"
                                  src="<?php echo site_url(); ?>/wp-content/uploads/directory-list-banner/ambulance_default.png"
                                  alt="<?= $name . ' - ' . site_url(); ?>"
                            ...
                            <div
                                ...
                                <div style="padding-top: 3%; float: right;">
                                    ...
                                    <div style="text-align: right; margin: 0; border: 0px solid red;" data-fontsize="18"
                                        ...
                                        <p>
                                            Address: <?php echo (!empty($address)) ? $address : 'N/A'; ?>
                                        </p>
                    ...
                    <div class="container-fluid">
                        <div id="col-md-12">
                            <p><?= get_user_meta($author_profile->ID, 'description', true); ?></p>

                            <p><strong>Our Mission:</strong></p>
                            <p><?= get_user_meta($author_profile->ID, 'mission', true); ?></p>
                            <hr>
                            <p><strong>Vision:</strong><br>
                                <?= get_user_meta($author_profile->ID, 'vision', true); ?></p>
            ...
            <section style="margin-bottom: 30px;">
                ...
                <span class="a2a_svg a2a_s__default a2a_s_twitter" style="background-color: #253e7f">
                    ...
                    <div class="row">
                        <div class="page-header">
                            <h1 style="text-align: center;">Specialized Doctors</h1>
                        </div>
                        <div class="col-sm-12">
                            <div id="specialized-doctors" class="owl-carousel mostafizd owl-loaded owl-drag">
                                <?php

                                foreach (getSpecilizedDoctors($author_profile->ID) as $key => $user) {
            ...
            <!-- END OF TESTIMONIALS -->
            <!--            START MAP-->
            <div id="third-row row" style="width: 100%; margin-bottom: 35px;">
                <div class="container-fluid">
                    <div class="page-header">
