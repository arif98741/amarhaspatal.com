                                    ...
                                    <?php if (isset($cust_query) && !empty($cust_query)) { ?>
                                        <ul id="tg-sortable" class="tg-tabs-nav tg-sortable" role="tablist">
                                            ...
                                            foreach ($cust_query as $key => $dir) {
                                                ...
                                                ?>
                                                <li data-dir_name="<?php echo esc_attr($title); ?>"
                                                    data-id="<?php echo intval($dir->ID); ?>"
                                                    class="<?php echo sanitize_html_class($active); ?> current-directory">
                                                    <input type="radio" <?php echo esc_attr($checked); ?>
                                                           name="directory_type" id="<?php echo intval($dir->ID); ?>"
                                                           value="<?php echo intval($dir->ID); ?>"/>
                                    ...
                                    <span class="tg-category-doctores"><?php echo intval(count($user_query->get_results())); ?><?php esc_html_e('Records', 'docdirect'); ?></span>
                                        ...
                                        <script type="text/template" id="tmpl-load-subcategories">
                                            <option value="">{{data['parent']}}
                                                - <?php esc_html_e('Specialities', 'docdirect'); ?></option>
                                            <#
                                            var _option    = '';
                                    ...
                                    ?>
                                                        ...
                                                        <?php if (isset($dir_keywords) && $dir_keywords === 'enable') { ?>
                                                            <div class="form-group">
                                                                <input type="text" name="by_name" class="form-control"
                                                                       placeholder="<?php esc_attr_e('Type Keyword...', 'docdirect'); ?>">
                                                            </div>
                                                        <?php } ?>
                                                        <?php if (!empty($zip_code_search) && $zip_code_search === 'enable') { ?>
                                                            <div class="form-group">
                                                                <input type="text" name="zip" class="form-control"
                                                                       placeholder="<?php esc_attr_e('Search users by zip code', 'docdirect'); ?>">
                                                            </div>
                                                        <?php } ?>
                                                        ...
                                                        <div class="form-group">
                                                            <a class="search_banner tg-btn pull-right"
                                                               href="javascript:;"><?php echo esc_attr($btn_title); ?></a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 col-xs-12 tg-verticalmiddle">
                                                        <h1><?php esc_attr_e('FIND YOUR', 'docdirect'); ?>
                                                            <span><?php esc_attr_e('NEAREST', 'docdirect'); ?></span>
