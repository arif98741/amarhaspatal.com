            ...
            <div class="tg-dashboard tg-docappointment tg-haslayout">
                <ul class="tg-navdocappointment" role="tablist">
                    <li role="presentation" class="active"><a href="#one" aria-controls="one" role="tab"
                                                              data-toggle="tab"><?php esc_html_e('offer service(s) and fee', 'docdirect'); ?></a>
                    </li>
                    <li role="presentation"><a href="#two" aria-controls="two" role="tab"
                                               data-toggle="tab"><?php esc_html_e('Time slot(s)', 'docdirect'); ?></a>
                    </li>
                    <li role="presentation"><a href="#three" aria-controls="three" role="tab"
                                               data-toggle="tab"><?php esc_html_e('Custom time slot(s)', 'docdirect'); ?></a>
                    </li>
                </ul>
                <div class="tab-content tg-appointmenttabcontent">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="tg-doccategoties">
                                        ...
                                        if (!empty($services_cats)) {
                                            foreach ($services_cats as $key => $value) {
                                                ...
                                                <div class="bk-category-item">
                                                    ...
                                                    <a href="javascript:;" class="bk-edit-category"><i
                                                                class="fa fa-edit"></i></a>
                                                    <a href="javascript:;" data-type="db-delete"
                                                       data-key="<?php echo esc_attr($key); ?>"
                                                       class="bk-delete-category"><i class="fa fa-trash-o"></i></a>
                                                </span>
                                                    </div>
                                                    <div class="tg-editcategory bk-current-category bk-elm-hide">
                                                        <div class="form-group">
                                                            <input data-key="<?php echo esc_attr($key); ?>" type="text"
                                                                   ...
                                                                   class="form-control service-category-title"
                                                                   name="categoryname"
                                                                   placeholder="<?php esc_attr_e('Category Title', 'docdirect'); ?>">
                                                        </div>
                                                        <div class="form-group tg-btnarea">
                                                            <button class="tg-update bk-maincategory-add"
                                                                    data-key="<?php echo esc_attr($key); ?>"
                                                                    data-type="update"
                                    ...
                                    <a id="search_banner" class="tg-btn tg-btn-lg bk-add-category-item"
                                       href="javascript:;"><?php esc_html_e('Add Category', 'docdirect'); ?></a>
                                </div>
                            </div>
                                            ...
                                            foreach ($booking_services as $key => $value) {
                                                ...
                                                <div class="bk-service-item">
                                                    <div class="tg-subdoccategory">
                                                        ...
                                                        <span class="tg-catelinks">
                                                    <a href="javascript:;" class="bk-edit-service"><i
                                                                class="fa fa-edit"></i></a>
                                                    <a href="javascript:;" data-type="db-delete"
                                                       data-key="<?php echo esc_attr($key); ?>"
                                                       class="bk-delete-service"><i class="fa fa-trash-o"></i></a>
                                                </span>
                                                    ...
                                                    <div class="tg-editcategory bk-current-service bk-elm-hide">
                                                                    ...
                                                                    if (!empty($services_cats)) {
                                                                        foreach ($services_cats as $cat_key => $cat) {
                                                                            ...
                                                                            <option <?php echo esc_attr($selected); ?>
                                                                                    value="<?php echo esc_attr($cat_key); ?>"><?php echo esc_attr($cat); ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control service-title"
                                                                   name="service_title"
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text"
                                                                   ...
                                                                   name="service_price"
                                                                   placeholder="<?php esc_attr_e('Add Price', 'docdirect'); ?> <?php echo esc_attr($currency_symbol); ?>">
                                                        </div>
                                                        <div class="form-group tg-btnarea">
                                                            <button class="tg-update  bk-service-add"
                                                                    data-key="<?php echo esc_attr($key); ?>"
                                                                    data-type="update"
                                                                    type="submit"><?php esc_html_e('Update Now', 'docdirect'); ?></button>
                                                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="two">
                        ...
                        <div class="tg-daytimeslot" data-day="sun">
                            <div class="tg-dayname">
                                ...
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="mon"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                        ...
                        <div class="tg-daytimeslot" data-day="tue">
                            <div class="tg-dayname"><strong><?php esc_html_e('Tuesday', 'docdirect'); ?></strong>
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="tue"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                            <div class="tg-timeslots">
                                <div class="timeslots-data-area">
                        ...
                        <div class="tg-daytimeslot" data-day="wed">
                            <div class="tg-dayname"><strong><?php esc_html_e('Wednesday', 'docdirect'); ?></strong>
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="wed"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                            <div class="tg-timeslots">
                                <div class="timeslots-data-area">
                        ...
                        <div class="tg-daytimeslot" data-day="thu">
                            <div class="tg-dayname"><strong><?php esc_html_e('Thursday', 'docdirect'); ?></strong>
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="thu"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                            <div class="tg-timeslots">
                                <div class="timeslots-data-area">
                        ...
                        <div class="tg-daytimeslot" data-day="fri">
                            <div class="tg-dayname"><strong><?php esc_html_e('Friday', 'docdirect'); ?></strong>
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="fri"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                            <div class="tg-timeslots">
                                <div class="timeslots-data-area">
                        ...
                        <div class="tg-daytimeslot" data-day="sat">
                            <div class="tg-dayname"><strong><?php esc_html_e('Saturday', 'docdirect'); ?></strong>
                                <ul class="tg-links">
                                    <li><a href="javascript:;" class="add-default-slots"
                                           data-key="sat"><?php esc_html_e('Add Time Slots', 'docdirect'); ?></a></li>
                                </ul>
                            </div>
                            <div class="tg-timeslots">
                                <div class="timeslots-data-area">
                    ...
                    <div role="tabpanel" class="tab-pane" id="three">
                                        ...
                                        foreach ($custom_slot_list as $key => $value) {
                                            ...
                                            <div class="tg-daytimeslot">
                                                <div class="custom-time-periods">
                                                    <div class="tg-dayname">
                                                        <a class="tg-deleteslot delete-slot-date" href="javascript:;"><i
                                                    ...
                                                    <div class="tg-timeslots tg-fieldgroup">
                                                        <div class="tg-timeslotswrapper">
                                                            <div class="form-group tg-calender">
                                                                <input type="hidden" class="custom_time_slots"
                                                                       name="custom_time_slots"
                                                                       value="<?php echo htmlentities(stripslashes(($value['custom_time_slots']))); ?>"/>
                                                                <input type="hidden" class="custom_time_slot_details"
                                                                       name="custom_time_slot_details"
                                                                       value="<?php echo htmlentities(stripslashes(($value['custom_time_slot_details']))); ?>"/>
                                                                <input type="text" class="form-control slots-datepickr"
                                                                       name="cus_start_date"
                                                            ...
                                                            <div class="form-group tg-calender">
                                                                <input type="text"
                                                                       ...
                                                                       class="form-control slots-datepickr"
                                                                       name="cus_end_date"
                                                                       placeholder="<?php esc_attr_e('End Date', 'docdirect'); ?>"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="tg-select">
                                                                    <select name="disable_appointment"
                                                                            class="disable_appointment">
                        ...
                        <div class="tg-daytimeslot custom-slots-action">
                            <button class="tg-btn bk-add-dates"
                                    type="button"><?php esc_html_e('Add Dates', 'docdirect'); ?></button>
                            <input type="hidden" class="custom_timeslots_object" name="custom_timeslots_object"
                                   value="<?php echo esc_attr($custom_slots); ?>"/>

                            <button class="tg-btn bk-save-custom-slots"
                                    type="button"><?php esc_html_e('Save Time Slots', 'docdirect'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bk-category-item">
        <div class="tg-doccategory">
            ...
            <span class="tg-catelinks">
				...
				<a href="javascript:;" data-type="new-delete" data-key="" class="bk-delete-category"><i
                            class="fa fa-trash-o"></i></a>
			</span>
        </div>
        <div class="tg-editcategory bk-current-category bk-elm-hide">
            <div class="form-group">
                <input type="text" class="form-control service-category-title" name="categoryname"
                       placeholder="<?php esc_html_e('Category Title', 'docdirect'); ?>">
            </div>
            <div class="form-group tg-btnarea">
                <button class="tg-update bk-maincategory-add" data-key="new" data-type="add"
                        type="submit"><?php esc_html_e('Update Now', 'docdirect'); ?></button>
            </div>
        </div>
    </div>
...
<script type="text/template" id="tmpl-update-service-category">
    <div class="tg-doccategory">
        ...
        <span class="tg-catelinks">
			<a href="javascript:;" class="bk-edit-category"><i class="fa fa-edit"></i></a>
			<a href="javascript:;" data-type="db-delete" data-key="{{data.key}}" class="bk-delete-category"><i
                        class="fa fa-trash-o"></i></a>
		</span>
    </div>
    <div class="tg-editcategory bk-current-category bk-elm-hide">
        <div class="form-group">
            <input type="text" data-key="{{data.key}}" value="{{data.title}}"
                   class="form-control service-category-title" name="categoryname"
                   placeholder="<?php esc_html_e('Category Title', 'docdirect'); ?>">
        </div>
        <button class="tg-update bk-maincategory-add" data-key="{{data.key}}" data-type="update"
                type="submit"><?php esc_html_e('Update Now', 'docdirect'); ?></button>
