			...
			<div class="form-group">  
				<div class="tg-privacy"> 
				  <div class="tg-iosstylcheckbox">
					...
					<input type="checkbox" class="privacy-switch" <?php echo isset( $privacy['chat_message'] ) && $privacy['chat_message'] === 'on' ? 'checked':'';?>  name="privacy[chat_message]" id="tg-chat_message">
				  ...
				  <span class="tg-privacy-name"><?php esc_html_e('Chat message notification','docdirect');?></span>
